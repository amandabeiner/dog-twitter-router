...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TwitterFeed = __webpack_require__(216);
	...
	var _MyPage = __webpack_require__(220);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_reactRouter.IndexRoute, { component: _TwitterFeed2.default }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Tweet = __webpack_require__(218);
	...
	var TwitterFeed = function (_React$Component) {
	  ...
	  function TwitterFeed(props) {
	    ...
	    _this.handleSelectedTweet = _this.handleSelectedTweet.bind(_this);
	    return _this;
	  }

	  _createClass(TwitterFeed, [{
	    key: 'handleSelectedTweet',
	    value: function handleSelectedTweet(id) {
	    ...
	    value: function render() {
	      ...
	      var tweets = _data2.default.map(function (tweet) {

	        if (tweet.id_str === _this2.state.selectedTweetId) {
	          className = "selected";
	        } else {
	          className = "";
	        }
	        ...
	        var handleClick = function handleClick() {
	          _this2.handleSelectedTweet(tweet.id_str);
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tweet = function Tweet(props) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    { onClick: props.handleClick, className: 'tweet-box ' + props.className },
	    _react2.default.createElement('img', { src: props.userPhoto }),
	    _react2.default.createElement(
	      'span',
	      null,
	      props.name
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FormContainer = __webpack_require__(221);

	var _FormContainer2 = _interopRequireDefault(_FormContainer);

	var _MyFeed = __webpack_require__(223);

	var _MyFeed2 = _interopRequireDefault(_MyFeed);
	...
	var MyPage = function (_Component) {
	  ...
	  function MyPage(props) {
	    ...
	    _this.trackTweet = _this.trackTweet.bind(_this);
	    return _this;
	  }

	  _createClass(MyPage, [{
	    key: 'trackTweet',
	    value: function trackTweet(submission) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_MyFeed2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormContainer = function (_Component) {
	  ...
	  function FormContainer(props) {
	    ...
	    _this.handleTweetChange = _this.handleTweetChange.bind(_this);
	  ...
	  _createClass(FormContainer, [{
	    ...
	    value: function handleTweetChange(event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyFeed = function MyFeed(props) {
